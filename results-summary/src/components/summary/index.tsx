...
function Summary() {
  return (
    <div className="flex flex-col mt-4 mx-9 gap-3">
      <h1 className="text-neutral-dark_blue font-bold text-xl">Summary</h1>
      <div className="bg-red-50 flex items-center justify-between h-14 rounded-md px-5">
        <div className="text-primary-red flex items-center gap-3">
      ...
      <div className="bg-yellow-50 flex items-center justify-between h-14 rounded-md px-5">
      ...
      <div className="bg-green-50 flex items-center justify-between h-14 rounded-md px-5">
      ...
      <div className="bg-blue-50 flex items-center justify-between h-14 rounded-md px-5">
      ...
      <div className="bg-neutral-dark_blue p-3 text-center rounded-3xl">
